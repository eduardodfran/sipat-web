...
function StatCard({
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl border border-white/[0.04] bg-surface px-5 py-4 shadow-2xl shadow-black/50 backdrop-blur-xl">
      <div
