  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] px-6 pb-6 pt-6">
      ...
      <div className="mb-8 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-7">
        ...
        <div className="rounded-xl border border-border bg-surface p-6">
          <p className="text-base font-bold uppercase tracking-widest text-text-muted">Avg / Hazard</p>
        ...
        <div className="rounded-xl border border-border bg-surface p-6">
          <p className="text-base font-bold uppercase tracking-widest text-text-muted">Community</p>
        ...
        <div className="space-y-6 lg:col-span-4">
          ...
          <div className="rounded-xl border border-border bg-surface p-5">
            ...
            <div className="space-y-3">
              <Link
                href="/map"
                className="flex items-center gap-2 rounded-md bg-white/[0.02] px-2.5 py-2 text-sm font-medium text-text-secondary transition-colors hover:bg-cyan-dim hover:text-cyan-accent"
              >
              ...
              <Link
                href="/rides"
                className="flex items-center gap-2 rounded-md bg-white/[0.02] px-2.5 py-2 text-sm font-medium text-text-secondary transition-colors hover:bg-green-safe/5 hover:text-green-400"
              >
